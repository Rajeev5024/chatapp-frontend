...
const Dashboard = () => {
	...
	const Appbar=(
		...
		>
		<Stack flexDirection={"row"} alignItems={"center"} spacing={"1.5rem"}>
			<AdminPanelSettingsIcon sx={{fontSize:"3rem"}}/>
			<SearchField placeholder='Search' />
			
			<CurveButton sx={{gap:"1.5rem"}} >Search</CurveButton>
			<Box flexGrow={1}/>
			<Typography
...
>
<DoughnutChart labels={["group chats", "Single chats"]} value={[stats?.groupsCounts,stats?.totalChatsCount-stats?.groupsCounts||0]}/>
